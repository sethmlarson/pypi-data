...
- [humanfriendly (<9.0,>=4.7)](packages/h/humanfriendly.md)
- [jmespath](packages/j/jmespath.md)
- [knack (==0.7.2)](packages/k/knack.md)
- [msal (~=1.0.0)](packages/m/msal.md)
- [msal-extensions (~=0.1.3)](packages/m/msal-extensions.md)
- [msrest (>=0.5.0)](packages/m/msrest.md)
- [msrestazure (>=0.6.3)](packages/m/msrestazure.md)
- [paramiko (<3.0.0,>=2.0.8)](packages/p/paramiko.md)
- [pkginfo (>=1.5.0.1)](packages/p/pkginfo.md)
- [pyjwt](packages/p/pyjwt.md)
- [pyopenssl (>=17.1.0)](packages/p/pyopenssl.md)
- [requests (~=2.22)](packages/r/requests.md)
