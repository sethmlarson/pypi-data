# [zope-session](https://pypi.org/project/zope-session)

## Dependencies
- [setuptools](packages/s/setuptools.md)
- [zodb (>=4.2.0.b1)](packages/z/zodb.md)
- [zope.component](packages/z/zope.component.md)
- [zope.i18nmessageid (>=4.0.3)](packages/z/zope.i18nmessageid.md)
...
- [zope.publisher (>=4.1.0)](packages/z/zope.publisher.md)



## Publishers
- [agroszer](https://pypi.org/user/agroszer)
- [amos](https://pypi.org/user/amos)
...
- [patricks](https://pypi.org/user/patricks)
