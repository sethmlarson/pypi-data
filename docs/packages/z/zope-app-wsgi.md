# [zope-app-wsgi](https://pypi.org/project/zope-app-wsgi)

## Dependencies
- [setuptools](packages/s/setuptools.md)
- [transaction](packages/t/transaction.md)
- [zconfig](packages/z/zconfig.md)
- [zope.app.appsetup (>=4.0)](packages/z/zope.app.appsetup.md)
- [zope.app.publication (>=4.0)](packages/z/zope.app.publication.md)
- [zope.component](packages/z/zope.component.md)
- [zope.configuration](packages/z/zope.configuration.md)
- [zope.container (>=4.0.0a1)](packages/z/zope.container.md)
...
- [zope.publisher (>=4.0.0a3)](packages/z/zope.publisher.md)
- [zope.security (>4.0.0a2)](packages/z/zope.security.md)
- [zope.session (>=4.0.0a1)](packages/z/zope.session.md)
- [zope.site (>=4.0.0a1)](packages/z/zope.site.md)
...
### testlayer
- [webtest; extra=='testlayer'](packages/w/webtest.md)


## Publishers
- [achapman](https://pypi.org/user/achapman)
...
- [jinty](https://pypi.org/user/jinty)
