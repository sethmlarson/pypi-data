# [zope-schema](https://pypi.org/project/zope-schema)

## Dependencies
- [setuptools](packages/s/setuptools.md)
- [zope.event](packages/z/zope.event.md)
- [zope.interface (>=5.0.0)](packages/z/zope.interface.md)
...
- [jcbrand](https://pypi.org/user/jcbrand)
- [jfroche](https://pypi.org/user/jfroche)
...
- [zvezdan](https://pypi.org/user/zvezdan)
