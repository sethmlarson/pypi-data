# [zope-location](https://pypi.org/project/zope-location)

## Dependencies
- [setuptools](packages/s/setuptools.md)
- [zope.interface (>=4.0.2)](packages/z/zope.interface.md)
- [zope.proxy (>=4.0.1)](packages/z/zope.proxy.md)
- [zope.schema (>=4.2.2)](packages/z/zope.schema.md)


## Extras

### component
- [zope.component (>=4.0.1); extra=='component'](packages/z/zope.component.md)
