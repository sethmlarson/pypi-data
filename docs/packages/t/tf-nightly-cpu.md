# [tf-nightly-cpu](https://pypi.org/project/tf-nightly-cpu)

## Dependencies
- [absl-py (~=0.10)](packages/a/absl-py.md)
- [astunparse (~=1.6.3)](packages/a/astunparse.md)
- [flatbuffers (~=1.12.0)](packages/f/flatbuffers.md)
...
- [tf-estimator-nightly (~=2.5.0.dev)](packages/t/tf-estimator-nightly.md)
- [typing-extensions (~=3.7.4)](packages/t/typing-extensions.md)
- [wheel (~=0.35)](packages/w/wheel.md)
- [wrapt (~=1.12.1)](packages/w/wrapt.md)



## Publishers
- [angersson](https://pypi.org/user/angersson)
- [annarev](https://pypi.org/user/annarev)
- [av8ramit](https://pypi.org/user/av8ramit)
- [goldiegadde](https://pypi.org/user/goldiegadde)
