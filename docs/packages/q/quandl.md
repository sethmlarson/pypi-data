...
## Dependencies
- [inflection (>=0.3.1)](packages/i/inflection.md)
- [more-itertools](packages/m/more-itertools.md)
- [numpy (>=1.8)](packages/n/numpy.md)
- [pandas (>=0.14)](packages/p/pandas.md)
- [python-dateutil](packages/p/python-dateutil.md)
- [requests (>=2.7.0)](packages/r/requests.md)
- [six](packages/s/six.md)



## Publishers
- [administrator-quandl](https://pypi.org/user/administrator-quandl)
- [couture-ql](https://pypi.org/user/couture-ql)
- [eric.vautour](https://pypi.org/user/eric.vautour)
