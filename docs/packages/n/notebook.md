...
- [jupyter-client (>=5.3.4)](packages/j/jupyter-client.md)
- [jupyter-core (>=4.6.1)](packages/j/jupyter-core.md)
...
- [gnestor](https://pypi.org/user/gnestor)
...
- [lresende](https://pypi.org/user/lresende)
