...
- [jsonschema (!=2.5.0,>=2.4)](packages/j/jsonschema.md)
- [jupyter-core](packages/j/jupyter-core.md)
- [traitlets (>=4.1)](packages/t/traitlets.md)


## Extras

### fast
- [fastjsonschema; extra=='fast'](packages/f/fastjsonschema.md)
...
- [mdpacer](https://pypi.org/user/mdpacer)
